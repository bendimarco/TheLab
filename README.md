...
After one idle second, a single-line “Drag left to expand” hint eases in just beside the right edge of the closed phone, with a gentle opening pulse that starts alongside the hint and repeats every four seconds. It opens to 9.5% over 0.85 seconds and closes over 1.05 seconds. Interacting dismisses the guidance for that visit; refreshing the page makes it available again. Reduced-motion preferences suppress the nudge.
