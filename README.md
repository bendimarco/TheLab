...
After one idle second, a single-line “Drag left to expand” hint eases in just beside the right edge of the closed phone, with a small opening nudge every four seconds. Interacting dismisses the guidance for that visit; refreshing the page makes it available again. Reduced-motion preferences suppress the nudge.
